...
public partial class TodoEditViewModel(ITodoStore? todoStore, TodoModel? todoModel = null) : ViewModelBase
{
    ...
    [ObservableProperty] private DateTime? _targetDate = DateTime.Now;//todoModel?.TargetDate ?? null;
